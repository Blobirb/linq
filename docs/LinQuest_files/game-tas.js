...
(function (Game) {
    var MainMenu = /** @class */ (function (_super) {
        ...
        function MainMenu() {
            ...
            _this.noadev.text.str = Game.HAS_LINKS ? Game.TEXT_NOADEV : "";
            ...
            if (!Game.HAS_LINKS) {
                new Game.CreditsNoLinksFrame(65 - 0.5 + 0.5);
            }
            new Game.SmallButtonFrame();
...
(function (Game) {
    var LevelText = /** @class */ (function (_super) {
        ...
        function LevelText() {
            ...
            _this.text.scale = (Game.Level.speedrun ? 0.6 : 0.7);
            _this.text.enabled = true;
            _this.text.pinned = true;
            ...
            _this.text.xAligned = 0;
            _this.text.yAligned = Game.Y_BUTTONS_TOP + (Game.Level.speedrun ? 0 : 0);
            if (Game.IS_TOUCH) {
    ...
    var SpeedrunTimer = /** @class */ (function (_super) {
        ...
        function SpeedrunTimer() {
            ...
            */
            ...
            _this.text.yAlignView = Utils.AnchorAlignment.START;
            _this.text.xAligned = 0;
            _this.text.yAligned = Game.Y_ARROWS_GAME_BUTTONS + 3.5;
            _this.fix();
            return _this;
        }
...
(function (Game) {
    ...
    var LevelTimer = /** @class */ (function (_super) {
        ...
        function LevelTimer() {
            ...
            _this.text.font = Game.FontManager.c;
            _this.text.scale = (Game.Level.speedrun ? 0.5 : 1);
            _this.text.enabled = true;
            _this.text.pinned = true;
            ...
            _this.text.yAlignView = Utils.AnchorAlignment.START;
            _this.text.xAligned = 0;
            _this.text.yAligned = Game.Y_ARROWS_GAME_BUTTONS + (Game.Level.speedrun ? 10 : 6);
            _this.fix();
            return _this;
        }
...
(function (Game) {
    ...
    var FRAME_CREDITS_NO_LINKS;
    Game.addAction("init", function () {
        FRAME_CREDITS_NO_LINKS = Game.FrameSelector.complex("frmtitlenolinks", Game.Resources.textureElina, 249, 486, null, 0, false)[0];
    });
    var CreditsNoLinksFrame = /** @class */ (function (_super) {
        __extends(CreditsNoLinksFrame, _super);
        function CreditsNoLinksFrame(y) {
            var _this = _super.call(this) || this;
            _this.sprite = new Engine.Sprite();
            _this.sprite.enabled = true;
            _this.sprite.pinned = true;
            _this.sprite.x = 0;
            _this.sprite.y = y;
            FRAME_CREDITS_NO_LINKS.applyToSprite(_this.sprite);
            return _this;
        }
        CreditsNoLinksFrame.prototype.onDrawBubblesDialog = function () {
            this.sprite.render();
        };
        return CreditsNoLinksFrame;
    }(Engine.Entity));
    Game.CreditsNoLinksFrame = CreditsNoLinksFrame;
    var FRAME_LAST;
    Game.addAction("configure", function () {
